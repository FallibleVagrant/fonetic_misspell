...
#from english_to_ipa.eng_to_ipa.transcribe import get_cmu, preprocess
from english_to_ipa.eng_to_ipa import transcribe
...
def syllable_count(word: str, db_type="sql"):
    ...
    word = get_cmu([preprocess(word)], db_type=db_type)
